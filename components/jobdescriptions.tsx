...
export default function JobDescriptionStep({ value, onChange }: Props) {
    ...
    <div className="space-y-5">
      ...
      <div>
        <label className="block text-xs font-semibold text-stone-500 uppercase tracking-wide mb-1.5">
          Job description <span className="text-[#FF7F62]">*</span>
        </label>

        {/* Toolbar */}
        <div className="flex items-center gap-1 px-2 py-1.5 bg-white border border-stone-200 border-b-0 rounded-t-lg">
          {[
          ...
          {[
            ...
            <button
              key={title}
              title={title}
              className="p-1.5 rounded text-stone-400 hover:bg-stone-50 hover:text-stone-600 transition-colors"
            >
              {icon}
            </button>
          ))}
          ...
          <button
            title="Heading"
            className="px-2 py-1 rounded text-xs font-semibold text-stone-400 hover:bg-stone-50 hover:text-stone-600 transition-colors"
          >
            H
          </button>
        </div>
        ...
        <textarea
          ...
          className="w-full px-3 py-2.5 bg-white border border-stone-200 rounded-b-lg text-sm text-[#081326] placeholder-stone-300 focus:outline-none focus:border-[#051163] focus:ring-2 focus:ring-[#051163]/10 resize-none leading-relaxed"
        />
