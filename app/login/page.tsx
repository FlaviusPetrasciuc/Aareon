...
export default function LoginPage() {
  ...
  const isValid = /^[^\s@]+@aareon\.nl$/.test(email);
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    // TODO: after Supabase confirms session, redirect:
    // router.push("/");
  }
        ...
        <div className="w-full max-w-sm">
          ...
          {submitted ? (
            ...
            <div className="text-center py-5">
              ...
              <h2 className="font-title text-2xl font-normal text-aareon-headline mb-2 italic">
                Check your inbox
              </h2>
              <p className="text-sm text-aareon-body font-light leading-relaxed font-body">
                We've sent a sign-in link to<br />
                <span className="text-aareon-bright font-medium">{email}</span>
              </p>
            </div>
          ) : (
            <>
                ...
                <div className="mb-5">
                  ...
                  {showError && (
                    <p className="font-body text-xs text-aareon-coral mt-1.5">
                      Please enter a valid @aareon.nl email address.
                    </p>
                  )}
                </div>
