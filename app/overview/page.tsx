            ...
            <main className="min-h-screen bg-[#f7f6f3] text-[#1f2937]">
                <div className="mx-auto max-w-7xl px-8 py-8">
                    ...
                    <div className="space-y-8 p-8">
                        <div>
                            <h2 className="mb-2 text-2xl font-serif text-[#172033]">
                                Frontend Developer
                            </h2>
                        ...
                        {/* Job Details Grid */}
                        <div className="grid grid-cols-2 gap-6 border-b border-[#e7e5e4] pb-4">
                            <div>
                        ...
                        {/* About the Role */}
                        <div>
                            <h3 className="mb-3 text-lg font-semibold text-[#172033]">
                                About the Role
                            </h3>
                        ...
                        <div>
                            ...
                            <ul className="mb-4 ml-2 list-inside list-disc space-y-1 text-gray-700">
                            ...
                            <ul className="mb-2 ml-2 list-inside list-disc space-y-1 text-gray-700">
